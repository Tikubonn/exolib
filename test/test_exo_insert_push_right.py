...
class TestEXOInsertPushRight (TestCase):
  ...
  def test_insert (self): 
    ...
    objnode2 = ObjectNode()
    objnode3 = ObjectNode()
    exo.insert_object(1, PositionRange(1, 24), objnode1, InsertionMode.PUSH_RIGHT)
    exo.insert_object(1, PositionRange(1, 24), objnode2, InsertionMode.PUSH_RIGHT)
    exo.insert_object(1, PositionRange(1, 24), objnode3, InsertionMode.PUSH_RIGHT)
