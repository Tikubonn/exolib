...
class TestObjectNode (TestCase):
  ...
  def test_positionize_shift_left (self):
    ...
    self.assertEqual(objnode1._positionize_shift_left(PositionRange(3, 4)).span(), (3, 4))
    self.assertEqual(objnode1._positionize_shift_left(PositionRange(4, 5)).span(), (3, 4))
    self.assertEqual(objnode1._positionize_shift_left(PositionRange(5, 6)).span(), (3, 4))
    self.assertEqual(objnode1._positionize_shift_left(PositionRange(6, 7)).span(), (3, 4))
    self.assertEqual(objnode1._positionize_shift_left(PositionRange(7, 8)).span(), (7, 8))
    self.assertEqual(objnode1._positionize_shift_left(PositionRange(8, 9)).span(), (7, 8))
    self.assertEqual(objnode1._positionize_shift_left(PositionRange(9, 10)).span(), (7, 8))
    self.assertEqual(objnode1._positionize_shift_left(PositionRange(10, 11)).span(), (7, 8))
    self.assertEqual(objnode1._positionize_shift_left(PositionRange(11, 12)).span(), (11, 12))
  ...
  def test_positionize_shift_right (self):
    ...
    objnode1.link_forward(objnode2)
    objnode2.link_forward(objnode3)
    self.assertEqual(objnode1._positionize_shift_right(PositionRange(1, 2)).span(), (3, 4))
    self.assertEqual(objnode1._positionize_shift_right(PositionRange(2, 3)).span(), (3, 4))
    self.assertEqual(objnode1._positionize_shift_right(PositionRange(3, 4)).span(), (3, 4))
    self.assertEqual(objnode1._positionize_shift_right(PositionRange(4, 5)).span(), (7, 8))
    self.assertEqual(objnode1._positionize_shift_right(PositionRange(5, 6)).span(), (7, 8))
    self.assertEqual(objnode1._positionize_shift_right(PositionRange(6, 7)).span(), (7, 8))
    self.assertEqual(objnode1._positionize_shift_right(PositionRange(7, 8)).span(), (7, 8))
    self.assertEqual(objnode1._positionize_shift_right(PositionRange(8, 9)).span(), (11, 12))
    self.assertEqual(objnode1._positionize_shift_right(PositionRange(9, 10)).span(), (11, 12))
    self.assertEqual(objnode1._positionize_shift_right(PositionRange(10, 11)).span(), (11, 12))
    self.assertEqual(objnode1._positionize_shift_right(PositionRange(11, 12)).span(), (11, 12))
  ...
  def test_objparam_node (self):
    objnode = ObjectNode()
    objparamnode1 = ObjectParamNode("example")
    objparamnode2 = ObjectParamNode("example")
    objparamnode3 = ObjectParamNode("example")
