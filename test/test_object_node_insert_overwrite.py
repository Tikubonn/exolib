...
class TestObjectNodeInsertOverwrite (TestCase):
  ...
  def test_insert_overwrite (self):
    ...
    self.assertEqual(tuple(moddedobjnodes[1].positionrange), (3, 3))
  ...
  def test_insert_overwrite5 (self):
    ...
    self.assertEqual(moddedobjnodes[2], objnode2)
    self.assertEqual(tuple(moddedobjnodes[2].positionrange), (7, 7))
    self.assertEqual(moddedobjnodes[3], objnode3)
    self.assertEqual(tuple(moddedobjnodes[3].positionrange), (10, 11))
  ...
  def test_insert_overwrite9 (self):
    ...
    self.assertEqual(moddedobjnodes[3], objnode3)
    self.assertEqual(tuple(moddedobjnodes[3].positionrange), (11, 11))
